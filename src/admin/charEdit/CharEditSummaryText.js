        ...
        <div className="flex flex-row">
          ...
          <div className="flex flex-col items-center justify-center space-y-2 pl-2">
            <svg
              ...
              viewBox="0 0 48 48"
              width="100%"
              className="max-w-[2.5rem] cursor-pointer fill-green-700"
              onClick={() => {
                editSummary({
                  variables: {
                    where: {
            ...
            <svg
              ...
              viewBox="0 0 48 48"
              width="100%"
              className="max-w-[2.5rem] cursor-pointer fill-red-700"
              onClick={() => {
                setSummary(charSummary);
                setEditing(false);
              }}
            >
...
export default CharEditSummaryText;
