...
const StanceHeaderText = ({ stanceID, stanceName, stanceNotation }) => {
  ...
  return (
    <div>
      {editing ? (
        ...
        <div className="flex w-full justify-center space-x-2 bg-header py-2">
          <h2 className="text-4xl text-[#F1F5F9]">{`${stanceName} (${stanceNotation})`}</h2>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 48 48"
...
export default StanceHeaderText;
